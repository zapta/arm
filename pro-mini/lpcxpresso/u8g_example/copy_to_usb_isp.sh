#!/bin/bash
#
# A Max OSX shell script to copy the generated binary image to the ISP virtual 
# USB disk. Can be added to lpcxpresso as an external tool that builds the 
# project before running this script.
#

# Binary file generated by lpcxpresso.
src="./Debug/u8g_example.bin"
