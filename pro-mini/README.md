...
The following YouTube video by Daniel Andrade from http://www.danielandrade.net demonstrates how to compile and run an ARM PRO MINI hello world program using mbed:
